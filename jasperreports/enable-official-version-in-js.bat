...
rem script 'enable-landclan-version-in-js.bat' was run and re-instates it as the main jar file so that Jaspersoft
rem Studio runs with the official jar.
...
rem TODO: Re-instate the official plugin jar
